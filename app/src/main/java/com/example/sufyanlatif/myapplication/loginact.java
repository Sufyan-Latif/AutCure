...
public class loginact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!sp.getString("type", "null").equals(null)) {
            ...
            if (connected)
            {
//                SPBackGroundWorkerInner spBackGroundWorkerInner= new SPBackGroundWorkerInner(loginact.this);
//                spBackGroundWorkerInner.execute("login", username, password);

            }
            else
                Toast.makeText(loginact.this, "No Internet connection", Toast.LENGTH_SHORT).show();
            if (sp.getString("type", "null").equals("parents")) {
                Intent intent = new Intent(loginact.this, parenthome.class);
                finish();
                startActivity(intent);

            } else if (sp.getString("type", "null").equals("students")) {
                Intent intent = new Intent(loginact.this, ChildHomeActivity.class);
                finish();
                startActivity(intent);
            }
            if (sp.getString("type", "null").equals("teacher")) {
                Intent intent = new Intent(loginact.this, teacherhome.class);
                finish();
                startActivity(intent);
            }
        }
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(loginact.this, authenticationact.class);
                finish();
                startActivity(intent);
            }
        });
