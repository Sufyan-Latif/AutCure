...
public class authenticationact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_authenticationact);
        ...
        if (!sp.getString("type", "null").equals(null)) {
            ...
            if (connected) {
                if (sp.getString("type", "null").equals("parents")) {
                    Intent intent = new Intent(authenticationact.this, parenthome.class);
                    finish();
                    startActivity(intent);
                } else if (sp.getString("type", "null").equals("students")) {
                    Intent intent = new Intent(authenticationact.this, ChildHomeActivity.class);
                    finish();
                    startActivity(intent);
                }
                if (sp.getString("type", "null").equals("teacher")) {
                    Intent intent = new Intent(authenticationact.this, teacherhome.class);
                    finish();
                    startActivity(intent);
                }
            }
//            else
//                Toast.makeText(authenticationact.this, "No Internet connection", Toast.LENGTH_SHORT).show();
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
                    ...
                    connected = false;
                if (connected) {
                    BackGroundWorkerInner backGroundWorkerInner = new BackGroundWorkerInner(authenticationact.this);
...
//                    Toast.makeText(authenticationact.this, "No Internet connection", Toast.LENGTH_SHORT).show();
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(authenticationact.this);
                ...
                builder.setTitle("Signup As !")
                        .setItems(users, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0) {
                                    Intent intent = new Intent(authenticationact.this, teachersignup.class);
                                    finish();
                                    startActivity(intent);
                                } else if (which == 1) {
                                    Intent intent = new Intent(authenticationact.this, signupparent.class);
                                    finish();
                                    startActivity(intent);
                                } else {
                                    Intent intent = new Intent(authenticationact.this, childsignup.class);
                                    finish();
                                    startActivity(intent);
                                }
                            }
...
//                    Toast.makeText(context, "No record", Toast.LENGTH_LONG).show();
                ...
                e.printStackTrace();
                progress.setVisibility(View.GONE);
                Toast.makeText(authenticationact.this, "Invalid Username or Password" +e, Toast.LENGTH_SHORT).show();
            }
