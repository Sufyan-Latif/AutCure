 ...
 */
public class childup extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_childup, container, false);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                childup2 childup2= new childup2();
                childup2.setArguments(bundle);
                fragmentTransaction.replace(R.id.frame,childup2);
