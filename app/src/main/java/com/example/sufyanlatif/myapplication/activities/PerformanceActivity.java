...
public class PerformanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Type type = new TypeToken<LinkedHashMap<Integer, Score>>() {
        }.getType();
...
//        LayoutInflater.from(parent.getContext()).inflate(R.layout.score_listview_row, parent, false);
        ...
        switch (gamesList.get(position)) {
            ...
            case "2":
                ...
                break;
            case "3":
                tvGameId.setText("Choose the Animal");
                break;
            case "4":
                tvGameId.setText("Choose the Fruit");
                break;
            case "5":
                tvGameId.setText("Choose the Vegetable");
                break;
        }
