...
public class signupparent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signupparent);

        FragmentTransaction fragmentTransaction=getSupportFragmentManager().beginTransaction();
        fragmentTransaction.add(R.id.frame,new parentup());
...
//                Intent intent= new Intent(signupparent.this,parenthome.class);
//                finish();
